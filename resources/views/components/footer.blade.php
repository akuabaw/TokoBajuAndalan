    ...
    <footer class="w-full text-gray-700 bg-gray-100 body-font">
        <div
            ...
            <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                <svg width="200" height="100" viewBox="0 0 200 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M26 32V30C26 26 30 22 34 22H46C50 22 54 26 54 30V32H60C62.2 32 64 33.8 64 36V64C64 66.2 62.2 68 60 68H20C17.8 68 16 66.2 16 64V36C16 33.8 17.8 32 20 32H26ZM30 32H50V30C50 28.9 49.1 28 48 28H32C30.9 28 30 28.9 30 30V32ZM20 36V64H60V36H20Z" fill="#0F0F0F"/>
                    
                    <!-- Brand Name -->
                    <text x="80" y="50" font-size="24" font-family="Arial, sans-serif" fill="#0F0F0F" font-weight="bold">ShopEase</text>
                </svg>
                </a>
                <p class="mt-2 text-sm text-gray-500">Happy Shoping!</p>
                <div class="mt-4">
        ...
        <div class="bg-gray-300">
            <div class="container px-5 py-4 mx-auto">
                <p class="text-sm text-gray-700 capitalize xl:text-center">© 2025 All rights reserved </p>
            </div>
        </div>
    </footer>
